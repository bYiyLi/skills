...
def retrieve(workspace: Path, mode: str, query: str, limit: int, config: dict, run_sync_callable) -> dict:
    ...
    for record in mode_documents if not query else []:
    ...
    return {"mode": mode, "query": query, "results": candidates[:limit]}
